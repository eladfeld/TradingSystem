...
function RenderInventroy({getAppState, setAppState, setPage, setProduct})
{
...
export default function Inventory({getAppState, setAppState}) {
  ...
  switch(page)
    {
    case("inventory"):
      return <RenderInventroy getAppState={getAppState} setAppState={setAppState} setPage={setPage} setProduct={setProduct}/>
    case("product"):
